-- D1 Database Schema for CMS Note Downloading
-- Run with: npx wrangler d1 execute cms-db --local --file=drizzle/schema.sql
...
VALUES (
  'dc5248d7-f8b4-4995-9182-f579e1620760',
  'admin@academy.com',
  '$2a$10$xG8VvJJxKJXQXvJXKJXQXvJXKJXQXvJXKJXQXvJXKJXQXvJXKJXQ',
  'Admin User',
  'admin'
);