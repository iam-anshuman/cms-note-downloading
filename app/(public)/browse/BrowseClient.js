      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {filteredNotes.map((note, index) => {
            ...
            let tags = [];
            try { tags = Array.isArray(note.tags) ? note.tags : JSON.parse(note.tags || "[]"); } catch {}
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <p className="text-sm text-on-secondary-container mb-4">
                    By {note.author_name}{note.pages > 0 ? ` • ${note.pages} Pages` : ""}
                  </p>
...
export function BrowseSuspenseWrapper() {
  return (
    <Suspense
      fallback={
